...
UUID = os.environ.get('UUID', '68e6bb1e-c8a9-4c81-91d7-b5a75db71be7')       # UUID
NEZHA_SERVER = os.environ.get('NEZHA_SERVER', 'nezha.170116.xyz')                  # 哪吒3个变量不全不运行
...
ARGO_AUTH = os.environ.get('ARGO_AUTH', 'eyJhIjoiZTIxNTdlZDNlZDAyZjhmN2MyZmJiMTQ1NzY5Y2ZiN2MiLCJ0IjoiOTA2OWNmMjctMzc1MC00MzEzLThlMjEtYTUxYTAzMjFhZTc5IiwicyI6Ill6bGxNbUV3TnpjdE5HSmhPQzAwWldRMkxXRmtNV0l0TXpkbU5XWmtOR1l6T0RVMCJ9')                                 # 国定隧道json或token，留空即启用临时隧道,json获取地址：https://fscarmen.cloudflare.now.cc
